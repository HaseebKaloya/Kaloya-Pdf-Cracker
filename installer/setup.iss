...
// ─── Dark Theme + Premium Font Styling ───────────────────────────────────────
// Inno Setup color format is $BBGGRR (reversed from HTML #RRGGBB)
// Dark bg  = $0A0A0A | Neon green = $41FF00 | Light text = $DDDDDD
procedure InitializeWizard();
begin
  // ── Make ALL background panels dark ──────────────────────────────────────
  WizardForm.Color           := $0A0A0A;
  WizardForm.MainPanel.Color := $0A0A0A;
  WizardForm.InnerPage.Color := $0A0A0A;

  // ── Welcome page: Big title (neon green, Consolas, bold, large) ───────────
  WizardForm.WelcomeLabel1.Font.Name  := 'Consolas';
  WizardForm.WelcomeLabel1.Font.Size  := 17;
  WizardForm.WelcomeLabel1.Font.Style := [fsBold];
  WizardForm.WelcomeLabel1.Font.Color := $41FF00;
  WizardForm.WelcomeLabel1.Color      := $0A0A0A;

  // ── Welcome page: Description body (Segoe UI, light gray) ────────────────
  WizardForm.WelcomeLabel2.Font.Name  := 'Segoe UI';
  WizardForm.WelcomeLabel2.Font.Size  := 10;
  WizardForm.WelcomeLabel2.Font.Color := $DDDDDD;
  WizardForm.WelcomeLabel2.Color      := $0A0A0A;

  // ── Finish page: Heading (neon green, Consolas, bold) ─────────────────────
  WizardForm.FinishedHeadingLabel.Font.Name  := 'Consolas';
  WizardForm.FinishedHeadingLabel.Font.Size  := 17;
  WizardForm.FinishedHeadingLabel.Font.Style := [fsBold];
  WizardForm.FinishedHeadingLabel.Font.Color := $41FF00;
  WizardForm.FinishedHeadingLabel.Color      := $0A0A0A;

  // ── Finish page: Body text ────────────────────────────────────────────────
  WizardForm.FinishedLabel.Font.Name  := 'Segoe UI';
  WizardForm.FinishedLabel.Font.Size  := 10;
  WizardForm.FinishedLabel.Font.Color := $DDDDDD;
  WizardForm.FinishedLabel.Color      := $0A0A0A;

  // ── Inner pages: Page title (e.g. "License Agreement") ───────────────────
  WizardForm.PageNameLabel.Font.Name  := 'Consolas';
  WizardForm.PageNameLabel.Font.Size  := 13;
  WizardForm.PageNameLabel.Font.Style := [fsBold];
  WizardForm.PageNameLabel.Font.Color := $41FF00;

  // ── Inner pages: Subtitle description ────────────────────────────────────
